...
int main(int argc, char** argv) {
	...
	std::string conf2N = "C:/Users/Wolfgang Brandenburg/Documents/Schnoeggersburg/Daten/OrientierungIII/DLR/52" + data2 + "_param.txt";
	...
	fundamentalmatrix = cameraA2.inverse().transpose() * S * R * cameraA1.inverse();
